...
def main():
    ...
    source=ROOT/'reports/recovery_20260917_native/probe_inputs.frozen.json';inp=json.loads(source.read_text());cases=inp['cases'][:1] if args.witness else inp['cases']
