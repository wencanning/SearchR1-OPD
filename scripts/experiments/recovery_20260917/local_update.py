...
See reports/recovery_20260917/LOCAL_UPDATE_PROTOCOL.md before interpreting results.
"""
import argparse
import hashlib
import json
...
def main():
    ...
    root=ROOT/'reports/recovery_20260917';summary=json.loads((root/'recovery_summary.json').read_text())
