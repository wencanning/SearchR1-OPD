...
def main():
    ...
    torch.cuda.set_per_process_memory_fraction(20*1024**3/torch.cuda.get_device_properties(0).total_memory)
    ...
    if args.witness:print('GPU4_RECOVERY_WITNESS_PASS',args.model,flush=True)
