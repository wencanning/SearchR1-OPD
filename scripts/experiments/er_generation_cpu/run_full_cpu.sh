#!/usr/bin/env bash
# Manual only: 20 disjoint questions, 180 generations, three replayed updates.
set -euo pipefail
...
nice -n 10 .venv/bin/python scripts/experiments/er_generation_cpu/run.py full
nice -n 10 .venv/bin/python scripts/experiments/action_calibration_cpu/verify_execution.py
nice -n 10 .venv/bin/python scripts/experiments/er_generation_cpu/analyze.py full
