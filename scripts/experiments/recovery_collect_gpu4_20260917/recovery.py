...
def main():
    p=argparse.ArgumentParser();p.add_argument('--phase',choices=['collect'],required=True);p.add_argument('--model',choices=['student'],required=True);p.add_argument('--out',type=Path,required=True);args=p.parse_args()
