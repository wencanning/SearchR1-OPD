...
# Vanilla OPD + vanilla GRPO control for the formal 0.5B ER-OPD run e4fmtict.
# Keep the formal-run values fixed so stale parent-shell exports cannot silently
# change the comparison. Intentional one-off Hydra overrides can still use "$@".
...
EXPERIMENT_NAME="opd-grpo-1B-0.01coef"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    algorithm.opd.target_token_chunk_size=512 \
    ...
    algorithm.opd.diagnostics.output_dir=null \
    ...
    actor_rollout_ref.rollout.seed=null \
